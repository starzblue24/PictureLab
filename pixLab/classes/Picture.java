...
public class Picture extends SimplePicture 
{
  ...
  public void GrayScale(){
    ...
    for (Pixel[] rowArray : pixels){
      for (Pixel pixelObj : rowArray){
        average = pixelObj.getGreen() + pixelObj.getRed() + pixelObj.getBlue();
        average=average/3;
  ...
  public void myCollage(){
    ...
    this.copy(koala,0,0);
    Picture kgray = new Picture(koala);
    kgray.GrayScale();
    this.copy(kgray, 485,0);
    this.copy(gorge, 484, 0);
    this.copy(butterfly, 484, 485);
  }
